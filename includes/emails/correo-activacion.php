...
<html>
    ...
    <div class="container">
        ...
        <div class="grupo1">
            ...
            <div class="opciones">
                <ul>
                    <li class="li_icon"><img src="<?php echo get_template_directory_uri (); ?>/assets/emails/assets/ico_estrella.png"/></li>
                    <li class="li_texto">Obtener notificaciones de noticias según tu equipo de preferencia.</li>
                    <li class="li_icon"><img src="<?php echo get_template_directory_uri (); ?>/assets/emails/assets/ico_lapiz.png"/></li>
                    <li class="li_texto">Enviarnos tus noticias para que puedan ser compartidas en nuestro portal.</li>
                    <li class="li_icon"><img src="<?php echo get_template_directory_uri (); ?>/assets/emails/assets/ico_checkbox.png"/></li>
        ...
        <div class="container-redes">
            <ul>
                <li class="texto_redes"><img src="<?php echo get_template_directory_uri (); ?>/assets/emails/assets/emr_texto.png"/></li>
