	...
	<html>
		...
		<body>
				...
				<div class="container">
					<div class="header">
						<div class="logo">
							<img src="<?php echo home_url( '/' ); ?>wp-content/themes/marcadordo/assets/emails/assets/logo-marcador-blanco.png"/>
					...
					<div class="container-redes">
						<ul>
							<li class="texto_redes"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/marcadordo/assets/emails/assets/logo-marcador-rojo.png" /></li>
							<li><a target="_blank" href="https://www.facebook.com/Marcador.do/"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/marcadordo/assets/emails/assets/emr_facebook.png" /></a>
							<li><a target="_blank" href="https://twitter.com/marcador_do"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/marcadordo/assets/emails/assets/emr_twitter.png" /></a>
							<li><a target="_blank" href="https://www.instagram.com/marcador.do/"><img src="<?php echo home_url( '/' ); ?>wp-content/themes/marcadordo/assets/emails/assets/emr_instagram.png" /></a>
						</ul>
				</div>
			</div>
