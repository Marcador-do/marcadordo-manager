<!DOCTYPE html>
	...
	<html>
		<head>
			...
			<title>Notificación_contrasena</title>
		...
		<body>
				...
				<div class="container">
					...
					<div class="grupo1">
						<p class="texto">
							Hola<span style="color:red">@usuario</span>. Tu contraseña fue cambiada recientemente.
							</p>

						<p>Si el acceso de tu usuario fue cambiado sin tu consentimiento, puedes hacer restablecer tu contraseña dando clic en el botón. Recuerda que el mismo solo estará vigente durante 24 horas.</p>
