...
function marcador_concurso_post_type() {

  $labels = array(
    'name'                  => _x( 'Concursos', 'Post Type General Name', 'marcadordo' ),
    'singular_name'         => _x( 'Concurso', 'Post Type Singular Name', 'marcadordo' ),
    'menu_name'             => __( 'Concursos', 'marcadordo' ),
    'name_admin_bar'        => __( 'Concursos', 'marcadordo' ),
  ...
  register_post_type( 'marcador_concurso', $args );

}
add_action( 'init', 'marcador_concurso_post_type', 0 );
